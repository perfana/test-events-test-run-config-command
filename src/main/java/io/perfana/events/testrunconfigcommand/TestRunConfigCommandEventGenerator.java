...
public class TestRunConfigCommandEventGenerator implements EventGenerator {

    private final EventLogger logger;
    private final EventGeneratorProperties properties;

    TestRunConfigCommandEventGenerator(EventGeneratorProperties properties, EventLogger logger) {
