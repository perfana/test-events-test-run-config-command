...
public class TestRunConfigCommandEventGeneratorFactory implements EventGeneratorFactory {

    @Override
    public EventGenerator create(EventGeneratorProperties eventGeneratorProperties, EventLogger eventLogger) {
        return new TestRunConfigCommandEventGenerator(eventGeneratorProperties, eventLogger);
    }
}
